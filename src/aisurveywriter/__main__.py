...
def parse_args():
    ...
    parser.add_argument("--embed-model", "-e", default="Alibaba-NLP/gte-Qwen2-1.5B-instruct", help="Text embedding model name")
...
def main():
    ...
    generate_paper_survey(
        ...
        refdb_path=args.bibdb,
        faissdb_path=args.faissbib,
